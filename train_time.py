...
LATEST_MODEL = 'saves/latest_model_time.pth'
...
def train():
    ...
    for epoch in range(1, 10001):
        ...
        while not done:
            ...
            epsilon = max(0.01, 0.1 - (epoch / 2000))
        ...
        if epoch % 10 == 0:
            ...
            logging_method.log('training_time_log.txt', f"Ep: {epoch} | Rew: {epoch_reward:.1f} | Current: {lap_time}s | Margin: {(global_best_lap - lap_time):.2f}s")
